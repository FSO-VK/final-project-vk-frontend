    ...
    return (
        <section class="medicine-card medicine-card_main">
            ...
            <div class="medicine-card__info">
                <span class="medicine-card__amount">{props.medicine.items} {props.medicine.itemsUnit}</span>
                <span class="medicine-card__expires">Годен до {props.medicine.expires.toLocaleDateString()}</span>
            </div>
        </section>
    )
}
